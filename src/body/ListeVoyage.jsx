...
},
{
  ...
  text: "La Tour Eiffel, le quartier Montmartre, le musée du Louvre... Découvrez tout le patrimoine historique et culturel d'une ville au mille facettes.", 
  prix: "379€",
}, {
  key:'',
  type: 'destination',
  ...
  text: "La Sagrada Familia, La Pedrera, le Parc Güell... Un circuit sur la route des majestueuses réalisations de l'architecte Antoni Gaudi.", 
  prix: "429€",
}, {
  key:'',
  type: 'destination',
  ...
  text: "Un circuit à la découverte de Venise et ses gondoles, ses canaux, ses ruelles... une ville magique sur l'eau qui ne laissera personne de marbre. ",
  prix: "530€",
}, {
  key:'',
  type: 'destination',
  ...
  text: "La Thaïlande regorge de lieux merveilleux, découvrez le pays du nord au sud, de Chiang Mai à l'île de Koh Phangan, en passant par Bangkok.",
  prix: "1249€",
}, {
  key:'',
  type: 'destination',
  ...
  text: "Découvrez le Maroc, ses medinas et ses souks animés au parfum d'épices, ses merveilleux palais, son hospitalité... circuit de Casablanca à Marrakech.",
  prix: "649€",
}, {
  key:'',
  type: 'destination',
  ...
  text: "Un superbe circuit de Split à Dubrovnik, à travers les îles de la Dalmatie, pour découvrir un pays au patrimoine naturel et historique riche.",
  prix: "760€"
}
];
